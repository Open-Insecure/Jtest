 ...
 * Time: 16:13
 */
public class TextGetForJava {
    /**读取文本编码格式*/
    private static String encoding="GBK";
    /**当前目录下的文件列表 放在全局 防止fileList递归调用后被重新置空 */
    private static List<String> fileList=new ArrayList();
    /**当前文件目录*/
    private static String filePath=  "C:\\Users\\Administrator\\Desktop\\三方源码\\deposit\\src\\com\\kayak\\deposit\\objects\\";
    /**生成的过滤文档路径*/
    private static String textPath="C:\\Users\\Administrator\\Desktop\\三方源码\\text_for_java.txt";
        ...
        try {
            ...
            for(String line:lines){
                if(line.contains("formula")){
                    ...
                    appendMehtod(line.replace("formula=\"(","").replace(")\"","").trim()+"\r\n");
                }
            }
        } catch (Exception e) {
