...
public class RandomUserNameTest {
    ...
    private static final String[] first_name = new String[]{"zhao","qian","sun","li","zhou","wang","mao","zheng","feng","chen","chu","wei","jiang","shen","yang"
            ,"zhu","qin","you","xu","he","shi","zhan","kong","cao","xie","jin","shu","fang","yuan"};//用户头
    ...
    public static void main(String[] args) {
        RandomUserNameTest ran = new RandomUserNameTest();
        for (int i = 0; i < 200; i++) {
//            System.out.println(ran.generate());
            System.out.println(ran.randomUserName());
        }
    }
