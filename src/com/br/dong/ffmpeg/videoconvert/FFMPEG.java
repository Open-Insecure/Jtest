package com.br.dong.ffmpeg.videoconvert;
...
//              d:\\:/ffmpeg/Logo.png  //Windows的logo或者水印路径
    ...
    public static void  main(String [] arg){
        ...
        dto.put("ffmpeg_path", "D:\\Program Files\\ffmpeg\\ffmpeg.exe");//必填
        dto.put("input_path", "D:\\Program Files\\ffmpeg\\input\\test.mp4");//必填
        dto.put("video_converted_path", "E:\\video\\10043.flv");//必填
        dto.put("logo", "e\\\\:/download/alert.jpg");//可选(注意windows下面的logo地址前面要写4个反斜杠,如果用浏览器里面调用servlet并传参只用两个,如 d:\\:/ffmpeg/input/logo.png)
